...
--                 local effect_str_1 = "jar_adjustable_missiles__effect__" .. stat .. "__" .. set
--                 local effect_str_2 = effect_str_1:gsub("missile", "missile_explosion")
--                 logger:write("effect_str", effect_str_1, effect_str_2)
--                 effect_bundle:add_effect(effect_str_1, "faction_to_force_own", value)
--                 effect_bundle:add_effect(effect_str_2, "faction_to_force_own", value)
--             else
--                 local effect_str = "jar_adjustable_missiles__effect__" .. stat .. "__" .. set
--                 logger:write("effect_str", effect_str)
