...
ga_ai_bret_01 = gb:get_army(gb:get_non_player_alliance_num(), 1, "First");
ga_ai_bret_02 = gb:get_army(gb:get_non_player_alliance_num(), 3, "Second");
ga_ai_bret_03 = gb:get_army(gb:get_non_player_alliance_num(), 3, "Third");
ga_ai_bret_04 = gb:get_army(gb:get_non_player_alliance_num(), 2, "Fourth");
ga_ai_bret_05 = gb:get_army(gb:get_non_player_alliance_num(), 2, "Fifth");
