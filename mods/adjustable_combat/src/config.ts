...
export const MOD_UNIT_SETS = [
    ...
    "jar_ac_unit_set_global",
    "jar_ac_unit_set_characters",

    "jar_ac_unit_set_single_entities",
    
    "jar_ac_unit_set_cavalry",
    "jar_ac_unit_set_chariots_war_machines",
    "jar_ac_unit_set_infantry",
    "jar_ac_unit_set_monstrous_infantry",
    "jar_ac_unit_set_war_beasts",
    "jar_ac_unit_set_artillery", // this one should technically only affect the crews
